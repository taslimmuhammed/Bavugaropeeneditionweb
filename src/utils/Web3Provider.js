...
import NFT from 'abis/BavugarOpenEdition.json'
import { REACT_APP_CHAINID, REACT_APP_CONTRACT_ADDRESS } from 'utils/config'

const WRONG_NETWORK = 'Please connect to the Ethereum Mainnet'
...
export class Web3Provider extends React.Component {
  ...
  getBlockchainData = async () => {
    ...
    const nftToken = new window.web3.eth.Contract(NFT.abi, REACT_APP_CONTRACT_ADDRESS)
